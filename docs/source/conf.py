# -*- coding: utf-8 -*-
#
# simple_aws_ssm_parameter_store documentation build configuration file, created by
...
import simple_aws_ssm_parameter_store as package
...
# Add data for Jinja2
try:
    from simple_aws_ssm_parameter_store.docs import doc_data
except:
    doc_data = dict()
